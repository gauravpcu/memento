...
import pytest
from memento import changedetection_app
from memento import store
import os
import sys
from loguru import logger

from memento.tests.util import live_server_setup, new_live_server_setup
...
def app(request):
    ...
    datastore = store.MementoStore(datastore_path=app_config['datastore_path'], include_default_watches=False)
