...
from memento.tests.util import live_server_setup, wait_for_all_checks
...
# -v `pwd`/tests/proxy_socks5/proxies.json-example:/app/memento/test-datastore/proxies.json
