...
from memento.content_fetchers import SCREENSHOT_MAX_HEIGHT_DEFAULT, visualselector_xpath_selectors, \
    SCREENSHOT_SIZE_STITCH_THRESHOLD, SCREENSHOT_MAX_TOTAL_HEIGHT, XPATH_ELEMENT_JS, INSTOCK_DATA_JS, FAVICON_FETCHER_JS
from memento.content_fetchers.base import Fetcher, manage_user_agent
from memento.content_fetchers.exceptions import PageUnloadable, Non200ErrorCodeReceived, EmptyReply, ScreenshotUnavailable
...
async def capture_full_page_async(page):
    ...
    if len(screenshot_chunks) > 1:
        from memento.content_fetchers.screenshot_handler import stitch_images_worker
...
class fetcher(Fetcher):
    ...
    async def run(self,
        ...
        async with async_playwright() as p:
            ...
            from memento.blueprint.browser_steps.browser_steps import steppable_browser_interface
