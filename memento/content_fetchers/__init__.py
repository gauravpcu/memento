...
from memento.content_fetchers.exceptions import BrowserStepsStepException
import os
...
from memento.content_fetchers.requests import fetcher as html_requests


import importlib.resources
XPATH_ELEMENT_JS = importlib.resources.files("memento.content_fetchers.res").joinpath('xpath_element_scraper.js').read_text(encoding='utf-8')
INSTOCK_DATA_JS = importlib.resources.files("memento.content_fetchers.res").joinpath('stock-not-in-stock.js').read_text(encoding='utf-8')
FAVICON_FETCHER_JS = importlib.resources.files("memento.content_fetchers.res").joinpath('favicon-fetcher.js').read_text(encoding='utf-8')
