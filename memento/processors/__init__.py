...
from memento.content_fetchers.base import Fetcher
...
class difference_detection_processor():
    ...
    async def call_browser(self, preferred_proxy_id=None):
        ...
        from memento import content_fetchers
        if hasattr(content_fetchers, prefer_fetch_backend):
            ...
            if prefer_fetch_backend == 'html_webdriver' and self.watch.has_browser_steps:
                ...
                from memento.content_fetchers.playwright import fetcher as playwright_fetcher
...
def find_processors():
    ...
    """
    package_name = "memento.processors"  # Name of the current package/module
...
def get_custom_watch_obj_for_processor(processor_name):
    from memento.model import Watch
