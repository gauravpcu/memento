...
def _task(watch, update_handler):
    from memento.content_fetchers.exceptions import ReplyWithContentButNoText
...
def prepare_filter_prevew(datastore, watch_uuid, form_data):
    ...
    from memento import forms, html_tools
    from memento.model.Watch import model as watch_model
