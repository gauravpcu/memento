...
from memento.strtobool import strtobool
from threading import Event
from memento.queue_handlers import RecheckPriorityQueue, NotificationQueue
from memento import worker_handler
...
from memento import queuedWatchMetaData
from memento.api import Watch, WatchHistory, WatchSingleHistory, CreateWatch, Import, SystemInfo, Tag, Tags, Notifications, WatchFavicon
from memento.api.Search import Search
...
from memento.auth_decorator import login_optionally_required
...
def changedetection_app(config=None, datastore_o=None):
    ...
    def gc_cleanup():
        from memento.gc_cleanup import memory_cleanup
    ...
    with app.app_context():
        while not app.config.exit.is_set():
            try:
                ...
                try:
                    from memento.notification.handler import process_notification
