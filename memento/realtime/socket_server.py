...
class SignalHandler:
    ...
    def __init__(self, socketio_instance, datastore):
        ...
        from memento.flask_app import watch_check_update as wcc
    ...
    def polling_emit_running_or_queued_watches_threaded(self):
        ...
        from memento.flask_app import app
...
def handle_watch_update(socketio, **kwargs):
    ...
    try:
        ...
        from memento.flask_app import update_q
        from memento.flask_app import _jinja2_filter_datetime
        from memento import worker_handler
...
def init_socketio(app, datastore):
    ...
    def event_checkbox_operations(data):
        from memento.blueprint.ui import _handle_operations
        from memento import queuedWatchMetaData
        from memento import worker_handler
        from memento.flask_app import update_q, watch_check_update
