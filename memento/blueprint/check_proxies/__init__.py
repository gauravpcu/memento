...
def construct_blueprint(datastore: MementoStore):
    ...
    def long_task(uuid, preferred_proxy):
        import time
        from memento.content_fetchers import exceptions as content_fetcher_exceptions
        ...
        now = time.time()
        try:
            processor_module = importlib.import_module("memento.processors.text_json_diff.processor")
