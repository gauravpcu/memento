...
def construct_blueprint(datastore: MementoStore):
    ...
    def ajax_callback_send_notification_test(watch_uuid=None):
        ...
        from memento.notification.apprise_plugin.assets import apprise_asset

        from memento.notification.apprise_plugin.custom_handlers import apprise_http_custom_handler
