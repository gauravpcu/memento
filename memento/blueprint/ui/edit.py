...
from memento.store import MementoStore
from memento.auth_decorator import login_optionally_required
from memento.time_handler import is_within_schedule
from memento import worker_handler

def construct_blueprint(datastore: MementoStore, update_q, queuedWatchMetaData):
    ...
    def edit_page(uuid):
        ...
        if request.method == 'POST' and form.validate():
            ...
            from memento.pluggy_interface import collect_ui_edit_stats_extras
            ...
            if form.extra_form_content():
                ...
                templates_dir = str(importlib.resources.files("memento").joinpath('templates'))
    ...
    def watch_get_preview_rendered(uuid):
        ...
        from memento.processors.text_json_diff import prepare_filter_prevew
