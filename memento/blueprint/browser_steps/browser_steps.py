...
from memento.content_fetchers import SCREENSHOT_MAX_HEIGHT_DEFAULT
from memento.content_fetchers.base import manage_user_agent
...
class browsersteps_live_ui(steppable_browser_interface):
    ...
    async def get_current_state(self):
        ...
        from memento.content_fetchers.playwright import capture_full_page_async
        ...
        xpath_element_js = importlib.resources.files("memento.content_fetchers.res").joinpath('xpath_element_scraper.js').read_text()
